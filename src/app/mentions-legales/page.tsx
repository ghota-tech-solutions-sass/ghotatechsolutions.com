            ...
            <div className="prose prose-lg prose-invert max-w-none">
              <section className="mb-8">
                ...
                <div className="bg-muted p-6 rounded-lg mb-6 border border-border">
                  ...
                  <ul className="space-y-2 text-muted-foreground">
                    <li><strong className="text-foreground">Dénomination sociale :</strong> Ghota Tech Solutions (GTS)</li>
                    <li><strong className="text-foreground">Forme juridique :</strong> Entreprise unipersonnelle à responsabilité limitée (EURL)</li>
                    <li><strong className="text-foreground">SIREN :</strong> 988 597 209</li>
                    <li><strong className="text-foreground">SIRET :</strong> 988 597 209 00010</li>
                    <li><strong className="text-foreground">Siège social :</strong> 268 RUE PAUL BERT 69003 LYON</li>
                    <li><strong className="text-foreground">Email :</strong> contact@ghotatechsolutions.com</li>
                    <li><strong className="text-foreground">Représentant légal :</strong> Mickaël Villers (Gérant)</li>
                  </ul>
                </div>
              </section>
              ...
              <section className="mb-8">
                ...
                <div className="bg-muted p-6 rounded-lg border border-border">
                  <p className="text-muted-foreground">
                    <strong className="text-foreground">GitHub Pages</strong><br />
                    GitHub, Inc.<br />
              ...
              <section className="mb-8">
                ...
                <p className="mb-4 text-muted-foreground">
                  ...
                  le signaler par email, à l&apos;adresse <span className="text-primary">contact@ghotatechsolutions.com</span>, en décrivant le problème de la
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-foreground mb-4">Collecte d&apos;informations</h2>
                <p className="mb-4 text-muted-foreground">
                ...
                <p className="mb-4 text-muted-foreground">
                  ...
                  <a href="/politique-confidentialite" className="text-primary hover:underline transition-colors">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-foreground mb-4">Droit applicable et attribution de juridiction</h2>
                <p className="text-muted-foreground">
